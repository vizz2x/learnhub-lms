-- ============================================
-- LEARNHUB LMS - PostgreSQL DATABASE SCHEMA
-- ============================================
...
CREATE TABLE modules (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT unique_module_order UNIQUE(course_id, sequence_number)
);
...
CREATE TABLE lessons (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT unique_lesson_order UNIQUE(module_id, sequence_number)
);
...
CREATE TABLE quiz_questions (
    ...
    sequence_number INTEGER NOT NULL,
    CONSTRAINT unique_question UNIQUE(quiz_id, sequence_number)
);
...
CREATE TABLE settings (
    ...
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT unique_setting UNIQUE(organization_id, setting_key)
);
